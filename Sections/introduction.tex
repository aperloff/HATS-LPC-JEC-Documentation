...
\frame{
	...
	\begin{columns}
	\begin{column}{3.2cm}                          
	\includegraphics[width=3.4cm]{images/JME-16-001/OffMeantnpuRef_BB_ak4pf_no2000_beforeL1.pdf}
	\end{column}
	\begin{column}{3.5cm}
	\includegraphics[width=3.4cm]{images/JME-16-001/OffMeantnpuRef_BB_ak4pfchs_no2000_beforeL1.pdf}
	\end{column}
	\begin{column}{3.5cm}
	\includegraphics[width=3.4cm]{images/JME-16-001/OffMeantnpuRef_BB_ak4puppi_no2000_beforeL1.pdf}
	\end{column}
	\end{columns}
}
%---------------------------------------------------------------------------------------------------------------------------------------
...
\frame{
	...
	\begin{columns}[T]
		...
		\begin{figure}[T]
			\centering
			\includegraphics[width=6.5cm]{images/L2Residuals.png}%  %no 13 TeV version
...
%				\caption{\footnotesize{Sketch by H. Kirschenmann}}
		...
		\begin{figure}[T]
				\centering
				\includegraphics[width=\textwidth]{images/unc.png}%  %no 13 TeV version
