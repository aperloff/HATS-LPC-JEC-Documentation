...
\frame{
	...
	\begin{itemize}
          ...
          \item Described on \href{https://twiki.cern.ch/twiki/bin/view/CMS/JECDataMC}{https://twiki.cern.ch/twiki/bin/view/CMS/JECDataMC}
          \item {Important to read the ``Notes'' associated to an update, which often describe partial update}
	\end{itemize}
}
%---------------------------------------------------------------------------------------------------------------------------------------
